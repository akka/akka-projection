...
Alternatively, you can fallback to the uppercase format. You will also need to set `akka.projection.slick.offset-store.table` to uppercase, as this setting is now defaulting to lowercase.

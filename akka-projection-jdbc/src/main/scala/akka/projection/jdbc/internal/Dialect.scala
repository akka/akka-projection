...
trait Dialect {
  ...
  val alterTableStatement: String

  val insertOrUpdateStatement: String
  val readOffsetQuery: String
  val clearOffsetStatement: String

}

/* Defines the basic statements. Dialects may use it or define their own.
 */
object DialectDefaults {
...
case class H2Dialect(schema: Option[String], tableName: String) extends Dialect {

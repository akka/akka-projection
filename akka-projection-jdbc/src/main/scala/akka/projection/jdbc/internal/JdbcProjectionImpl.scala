      ...
      offsetStore
        ...
        .recover {
          case exc =>
            ...
            logger.info(
              "Create the [akka_projection_management] table if you have updated to version 1.1.1 or later. See schema at https://doc.akka.io/docs/akka-projection/current/jdbc.html#schema cause: {}",
              exc)
            false
        }
    }

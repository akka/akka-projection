...
object Dependencies {
  ...
  object Versions {
    val Akka = sys.props.getOrElse("build.akka.version", "2.10.13")
    ...
    val AlpakkaKafka = sys.props.getOrElse("build.alpakka.kafka.version", "8.0.2")
  ...
  object Test {
    ...
    val h2Driver = "com.h2database" % "h2" % "2.4.240" % sbt.Test

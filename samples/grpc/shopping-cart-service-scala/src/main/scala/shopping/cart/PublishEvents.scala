...
object PublishEvents {
  ...
  //#transformItemAdded
  private def transformItemAdded(added: ShoppingCart.ItemAdded): proto.ItemAdded =
    proto.ItemAdded(
      cartId = added.cartId,
      itemId = added.itemId,
  ...
  def transformItemQuantityAdjusted(event: ShoppingCart.ItemQuantityAdjusted): proto.ItemQuantityAdjusted =
  ...
  def transformCheckedOut(event: ShoppingCart.CheckedOut): proto.CheckedOut = proto.CheckedOut(event.cartId)
